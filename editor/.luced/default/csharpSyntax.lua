	...
	root = {
        ...
        singlequoted = {
        	style = "string",
                ...
                maxBeginExtend   = 2,
                maxEndExtend     = 2,
                childPatterns    = { "singlequotedescape", "singlequotedchar", "singlequotederror" },
        },
        ...
        constructorDef = {
                style = "subroutine",
                pattern          = [[\b(?P<constructorDefModifier>abstract|sealed|native|private|protected|public|static|synchronized)\s*[\n|\s]\s*[a-zA-Z_]\w*\s*\n?\s*(?=\()]],
                maxExtend        = 100,
        ...
        keywords = {
                style = "keyword",
                pattern          = [[\b(?: abstract| sealed    | native       | private  | protected | public
